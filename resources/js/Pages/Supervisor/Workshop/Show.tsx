...
type SupervisorWorkshopShowProps = {
    title: string;
    workshop: Workshop;
};

export default function SupervisorWorkshopShow({
    title,
    workshop,
}: SupervisorWorkshopShowProps) {
    return (
            ...
            <Card className="shadow-md p-4 mb-4 flex flex-col relative overflow-hidden">
                <div className="z-10">
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        <h3 className="text-lg font-semibold">Identitas Lokasi</h3>
                    </div>
                ...
                <div className="flex flex-col z-10">
                    ...
                    />
                    <KeyAndValue
                        keyIdentifier="Nama Pemimpin / Pendamping"
                ...
                {workshop?.supervisor == null ? (
                    ...
                    <div className="flex flex-col z-10">
                        ...
                        <KeyAndValue
                            ...
                            value={`${workshop?.supervisor.full_name} (Anda) `}
                        />
                        <KeyAndValue
